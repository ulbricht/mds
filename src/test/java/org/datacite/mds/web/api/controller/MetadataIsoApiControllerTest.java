...
@Transactional
public class MetadataIsoApiControllerTest {
    ...
    MetadataIsoApiController metadataApiController = new MetadataIsoApiController();
    ...
    private MockHttpServletRequest makeServletRequestForDoi(String doi) {
        ...
        request.setServletPath("/isometadata/" + doi);
        return request;
    }
    ...
    public void testGet() throws Exception {
        ...
        assertArrayEquals(metadata.getIso(), (byte[]) response.getBody());
    ...
    public void testPostTestMode() throws Exception {
        metadata.remove();
        HttpStatus responseStatus = postwithdoi(iso, true);
        assertEquals(HttpStatus.CREATED, responseStatus);
    }
